...
def qDrawPlainRect(QPainter, p_int, p_int_1, p_int_2, p_int_3, Union, QColor=None, Qt_GlobalColor=None, QGradient=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
